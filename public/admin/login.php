              ...
              <div class="bg-background flex-auto p-6">
                ...
                <form id="" class="mb-4" action="#" method="POST">
                  <div class="mb-4">
                    ...
                    <input type="text" name="email" class="bg-background block w-full cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow" id="email" name="email-username" placeholder="Enter your email or username" autofocus="" />
                  </div>
                  <div class="mb-4">
                    ...
                    <div class="relative flex w-full flex-wrap items-stretch">
                      <input type="password" name="password" id="password" class="bg-background relative block flex-auto cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-blue-600 focus:bg-background  focus:text-gray-600 focus:shadow" name="password" placeholder="············" />
                    </div>
                  </div>
                  <div class="mb-4">
                    <div class="block">
