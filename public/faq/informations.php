            ...
            <div class="w-3/4 p-4">
                ...
                <div class="accordion-item border-b border-gray-200">
                    ...
                    <div class="accordion-content p-4">
                        <p>Yes, we provide a size chart for each product category to help you find the best fit. You can find it on the product page or under our Size Guide section.</p>
                    </div>
                </div>
                <div class="accordion-item border-b border-gray-200">
                    <div class="accordion-header flex justify-between items-center cursor-pointer p-4" onclick="toggleAccordion(this)">
                    ...
                    <div class="accordion-content p-4">
                        <p>Follow our detailed size guide instructions to measure yourself accurately. This ensures you select the correct size based on your measurements and the product's fit.</p>
                    </div>
                </div>
                <div class="accordion-item border-b border-gray-200">
                    <div class="accordion-header flex justify-between items-center cursor-pointer p-4" onclick="toggleAccordion(this)">
                ...
                <div class="accordion-item border-b border-gray-200">
                    ...
                    <div class="accordion-content p-4">
                        <p>Our products are made from high-quality materials such as cotton, polyester, nylon, and blends specified on each product page.</p>
                    </div>
                </div>
                <div class="accordion-item border-b border-gray-200">
                    <div class="accordion-header flex justify-between items-center cursor-pointer p-4" onclick="toggleAccordion(this)">
                ...
                <div class="accordion-item border-b border-gray-200">
                    ...
                    <div class="accordion-content p-4">
                        <p>On each product page, availability status (in stock/out of stock) is indicated near the size selection. If a product is out of stock, you may choose to receive notifications when it becomes available.</p>
                    </div>
                </div>
            </div>
        </div>
