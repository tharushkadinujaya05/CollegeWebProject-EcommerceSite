  ...
  <header
    ...
    <div class="px-4">
        <div class="flex items-center justify-between">
            ...
            <a id="cart-button" class="hidden items-center justify-center px-3 py-2 text-sm font-nunito  sm:inline-flex"
    ...
    <div
      class="relative bg-cover bg-center h-[36rem] md:h-[40rem]"
      style="background-image: url('../../assets/images/blog01.png')"
    >
      ...
      >
        <p
          class="text-white text-3xl md:text-5xl text-center mb-4 font-poppins"
        >
          Explore
        </p>
        <p class="text-white text-base md:text-2xl text-center font-nunito">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        ...
        <p class="mt-1 text-gray-600 dark:text-neutral-400 font-nunito">
          Explore our recent posts and insights.
        </p>
      </div>
